          ...
          <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
            ...
            <div className='col-span-2 flex flex-col items-end justify-around xl:col-span-8 xl:flex-row xl:items-center md:order-3'>
              ...
              <div className='flex flex-col items-end justify-center xl:items-center'>
                ...
                <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-primaryDark xl:text-center md:text-lg sm:text-base xs:text-sm'>years of experience</h2>
              </div>
            </div>
          </div>
          <Skills/>
